    ...
    *,
    ...
    try:
        ...
        hot = pick_from_hot_sectors(
            ...
            ma5_require_capital=ma5_require_capital,
...
def watchlist_fill_hot_sectors(
    ...
    try:
        hot = _run_hot_pick_common(
            ...
            ma5_require_capital=body.ma5_require_capital,
...
def watchlist_hot_sectors_preview(
    ...
    ma5_require_capital: bool = Query(False, description="false=仅看MA5，不要求东财资金"),
